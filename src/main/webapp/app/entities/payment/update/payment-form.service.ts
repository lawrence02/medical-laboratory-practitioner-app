...
type PaymentFormGroupContent = {
  ...
  registrationNumber: FormControl<IPayment['registrationNumber']>;
  datePaid: FormControl<IPayment['datePaid']>;
  subscriptionPeriod: FormControl<IPayment['subscriptionPeriod']>;
...
export class PaymentFormService {
  createPaymentFormGroup(payment: PaymentFormGroupInput = { id: null }): PaymentFormGroup {
    ...
    return new FormGroup<PaymentFormGroupContent>({
      ...
      registrationNumber: new FormControl(paymentRawValue.registrationNumber),
      datePaid: new FormControl(paymentRawValue.datePaid),
      subscriptionPeriod: new FormControl(paymentRawValue.subscriptionPeriod),
