...
import qualificationResolve from './qualification-routing-resolve.service';

describe('Qualification routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: QualificationService;
  let resultQualification: IQualification | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IQualification returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        qualificationResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultQualification).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IQualification>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
