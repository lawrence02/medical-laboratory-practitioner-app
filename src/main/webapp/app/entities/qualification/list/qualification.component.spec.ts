...
import { sampleWithRequiredData } from '../qualification.test-samples';
...
describe('Qualification Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.qualifications()[0]).toEqual(expect.objectContaining({ id: 18515 }));
  });

  describe('trackId', () => {
    it('Should forward to qualificationService', () => {
      const entity = { id: 18515 };
      jest.spyOn(service, 'getQualificationIdentifier');
      const id = comp.trackId(entity);
      expect(service.getQualificationIdentifier).toHaveBeenCalledWith(entity);
