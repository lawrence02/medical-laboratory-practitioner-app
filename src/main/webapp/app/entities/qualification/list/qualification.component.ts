...
import { EntityArrayResponseType, QualificationService } from '../service/qualification.service';
...
export class QualificationComponent implements OnInit {
  ...
  trackId = (item: IQualification): number => this.qualificationService.getQualificationIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.qualifications.set(dataFromBody);
  }

  protected fillComponentAttributesFromResponseBody(data: IQualification[] | null): IQualification[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.qualificationService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
