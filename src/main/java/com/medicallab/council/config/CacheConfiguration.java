package com.medicallab.council.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.medicallab.council.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.medicallab.council.repository.UserRepository.USERS_BY_EMAIL_CACHE);
