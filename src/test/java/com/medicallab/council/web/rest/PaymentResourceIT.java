...
import static com.medicallab.council.domain.PaymentAsserts.*;
...
class PaymentResourceIT {
    ...
    void partialUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.datePaid(UPDATED_DATE_PAID).subscriptionPeriod(UPDATED_SUBSCRIPTION_PERIOD);
